export function renderNavbar() {
  return `
    <header id="header" class="h-16 border-b border-slate-800 bg-slate-900/50 backdrop-blur flex items-center justify-between px-6 sticky top-0 z-40">
      ...
      <!-- LADO IZQUIERDO: Menú Hamburguesa, Ubicación y Reloj -->
      <div class="flex items-center gap-4">
        <button id="toggle-sidebar-btn" class="p-2 text-slate-400 hover:text-white lg:hidden btn btn-ghost">
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex items-center gap-2 cursor-pointer border-l border-slate-800 pl-3">
          <img src="https://i.pinimg.com/1200x/86/d8/bb/86d8bbb2cf99f13b0d16f1f9bd22afd8.jpg" class="w-8 h-8 rounded-full border-2 border-slate-700 object-cover" alt="Avatar" />
